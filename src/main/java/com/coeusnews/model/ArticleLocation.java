...
public class ArticleLocation {
    ...
    public ArticleLocation(String id, String author_name, String title, String category, String description, String article_text, String article_image_URL, String article_URL, String updated_at, String published_at, String article_status, String article_location, String article_approved_by, String source, int counter) {
        this.id = id;
